...
const MovieItem = ({ movie }: { movie: Movie }) => {
  return (
    <div className="relative overflow-hidden rounded-md shadow-sm h-96 cursor-pointer">
      ...
      {/* Overlay */}
      <div className="absolute inset-0 z-10 rounded-md bg-gradient-to-b dark:from-slate-900/10 dark:via-slate-900/50 dark:to-slate-900 from-white/10 via-white/30 to-white" />
      {/* BG Image */}
      <Image
